  ...
  return (
    <main className="font-Silka">
      ...
      <footer className="bg-indigo-50">
        <div className="mx-auto max-w-screen-xl py-20 w-full">
          <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
              ...
              <div>
                <ul className="font-normal leading-7 text-gray-800 text-sm tracking-wide">
                  <li className="flex gap-3 items-center">
                    ...
                    <span className="border-2 border-blue-400 flex font-bold h-6 items-center px-2.5 rounded-full text-blue-800 text-xs uppercase">
                      coming soon
                    </span>
                  </li>
                </ul>
            ...
            <div>
              <h2 className="font-semibold mb-6 text-sm text-indigo-500 uppercase">
                industry
              </h2>
              <ul className="font-normal leading-7 text-gray-800 text-sm tracking-wide">
                <li>
